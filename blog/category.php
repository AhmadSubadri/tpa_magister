			...
			<article class="post">
				<header>
					...
					<div class="meta">
						...
						<a href="#" class="author"><span class="name"><?php echo $r[penulis];?></span><img
								src="../admin/foto/<?php echo $r[dp];?>" alt="" /></a>
					</div>
				</header>
				...
				<footer>
					<ul class="actions">
						<li><?php echo "<a target='_blank' class='button big' href=\"".$url_link."\">continue reading</a>";?>
						</li>
					</ul>
					<ul class="stats">
...
SELECT cat_post.nama,cat_post.id,post.id_kategori, COUNT(post.id_kategori) as jml FROM cat_post,post WHERE post.id_kategori=cat_post.id GROUP BY cat_post.nama") or die("gagal".mysql_error());
						...
						$url_cate="kategori".$rx['id_kategori']."-".$catez.".html";
										?>
						<header>
							<h4><a href="<?php echo"$url_cate";?>"><?php echo"$rx[nama]";?><a href="#"
										class="apikbanget"><span><?php echo"$rx[jml]";?></span</a> </a> </h4> </header>
												<?php }?> </article> </div> </section> <!-- Posts List -->
											<section>
												<ul class="posts">
													<?php
							...
							?>
													<li>
														<article>
															<header>
																<h3><a target='_blank'
																		href=" <?php echo $url_ku;?>"><?php echo"$rz[judul]";?></a>
																</h3>
																<time
																	class="published"><?php echo(DateToIndo("$rz[tanggal]"));?></time>
															</header>
															<a href="#" class="image"><img
																	src="../uploads/<?php echo"$rz[feature_image]";?>"
																	alt="" /></a>
														</article>
													</li>
													<?php }?>
											...
											<section class="blurb">
												...
												<p>Selamat datang di E-Learning <?php echo $course;?><br />
													<?php echo $course;?> merupakan sebuah aplikasi berbasis web yang di
													gunakan untuk ujian online Silahkan anda mendaftar terlebih dahulu
													agar dapat melakukan ujian online setelah anda selesai mendaftar
													silahkan login. di halaman user anda dapat mengedit biodata. dan
													dapat mengerjakan soal, dan anda langsung dapat melihat nilainya dan
													langsung bisa untuk di cetak</p>
