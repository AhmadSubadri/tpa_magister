		...
		<div id="main">
			...
			<article class="post">
				...
				<section>
					...
					<p><span class="image left"><img src="../uploads/<?php echo"$r[feature_image]";?>"
								alt="" /></span><?php echo $r[isi];?></p>
...
SELECT cat_post.nama,cat_post.id,post.id_kategori, COUNT(post.id_kategori) as jml FROM cat_post,post WHERE post.id_kategori=cat_post.id GROUP BY cat_post.nama") or die("gagal".mysql_error());
						...
						<header>
							<h4><a href="<?php echo"$url_cate";?>"><?php echo"$rx[nama]";?><a href="#"
										class="apikbanget"><span><?php echo"$rx[jml]";?></span</a> </a> </h4> </header>
												<?php }?> </article> </div> </section> <section>
											<ul class="posts">
												<?php
			...
			<section class="blurb">
				...
				<p>Selamat datang di E-Learning <?php echo $course;?><br />
					...
					Silahkan anda mendaftar terlebih dahulu agar dapat melakukan ujian online setelah anda selesai
					mendaftar silahkan login. di halaman user anda dapat mengedit biodata. dan dapat mengerjakan soal,
