          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" id="judul">
              ...
              <div class="input-group">
                ...
                </div><input name='nama' class="form-control" disabled size="100" placeholder="nama"
                  value="<?php echo"$qq[firstn]  $qq[lastn]";?>" />
              </div><!-- /.input group -->
            </div><!-- /.form group -->
            ...
            <a href="9760e2cb7c0c272f0ba87a4b500b54cb"><input type="button" class="btn btn-info"
