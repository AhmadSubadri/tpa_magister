	...
	<div class="Section">
		<table width=100%>
			<tr>
				...
				<td width=663 height="41" align=center>
					<h3>UJIAN ONLINE <?php echo "$course";?></h3>
				</td>
			</tr>
			<tr>
				<td align=center>
					<p style="line-height:4px"><?php echo "$alamat";?></p>
					<p> Telp : <?php echo "$no_telp";?> | Email : <?php echo "$email";?></p>
				</td>
			</tr>
			<tr>
		...
		<table width="100%" border="0" height="auto">
				...
				<td height="120">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#666666">
						<tr height="20">
							...
							<td width="237"><span class="MsoNormal"><span class="style13">:
										<?php echo $rrss[nama_ujian];?></span></td>
							<td width="99"><span class="MsoNormal">Kelas</span></td>
							<td width="108"><span class="MsoNormal"><span class="style13">: Reguler</span></td>
						</tr>
						<tr height="20">
							...
							<td><span class="MsoNormal"><span class="style13">: 1</span></td>
						</tr>
						<tr height="20">
							<td width="116"><span class="MsoNormal">Nomor Peserta</span></td>
							<td><span class="MsoNormal"><span class="style13">: <?php echo"$dataus[id_userk]";?></span>
							</td>
							<td><span class="MsoNormal">Tahun Akademik</span></td>
							<td><span class="MsoNormal"><span class="style13">: <?php echo (int)date('Y')?></span></td>
						</tr>
			...
			<tr>
				<td>
					<table class="halus" width="100%">
						<thead>
							<tr>
								<td width="21%" align="center"><b>MATA KULIAH</b></font>
								</td>

								<td width="21%" align="center"><b>NILAI ANGKA</b></td>
								<td width="19%" align="center"><b>NILAI HURUF</b></td>
							</tr>
						</thead>
						<?php
			...
			<tr>
				<td>
					...
					<table width="100%" border="0">
						...
						<tr>
							<td height="38">
								<div align="center"><span class="style3"><span class="style4"><span
												class="style11"><span class="style12"></span></span></span></span></div>
							</td>
							<td height="38">&nbsp;</td>
							<td height="38">
								<div align="center"><span class="style3"><span class="style4"><span
						...
						<tr>
							...
							<td>&nbsp;</td>
							<td>
								<div class="style13"> <u><?php echo "$founder";?> cS.Kom</u> </div>
							</td>
						</tr>
					</table>
