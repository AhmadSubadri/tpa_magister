					...
					$.ajax({
						...
						success: function (data) {
							if (data) {
								...
								$("#login").val('Login')
								$("#error").html(
									"<span style='color:#cc0000'>Error:</span>  username and password Salah !!!. "
									);
							}
						}
					});
		...
		<div id="overlay-1">
			...
			<section id="starting">
				<div class="text-center starting-text wow animated zoomInDown">
					...
					<p style="color: white;">Sistem Seleksi Penerimaan Mahasiswa Baru<br>Program Magister</p>
	...
	<section id="about">
		<div class="container">
			...
			<div class="row about-us-text">
				<div class="col-md-12">
					<p class="text-center">Selamat datang di Sistem <?php echo"$course";?><br>
						...
						setelah anda selesai mendaftar silahkan login. di halaman user anda dapat mengedit biodata. dan
...
?>
						<div class="col-md-3 col-sm-6">
							<div class="service">
								...
								<div class="text-center">
									<h4><?php echo "<a target='_blank' class='button big' href=\"".$url_link."\">$r[judul]</a>";?>
									</h4>
									<p>
										<?php
			...
			<div class="row main_content">
				<div class="col-md-10 col-md-offset-1">
					<div id="client-speech" class="owl-carousel owl-theme">
						...
						?>
						<div class="item">
							<img class="img-circle radiusku img-responsive center-block"
								src="user/foto/<?php echo"$r[dp]";?>" alt="text">
					...
					<div class="col-md-10 col-md-offset-2 well">
						<div class="form">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input class="form-control error" type="text" name="lastname" placeholder="Last Name"
									id="lastname">
							</div>
							...
							<div class="input-group margin-bottom-sm">
								...
								<input class="form-control" type="text" name="username" placeholder="username"
									id="usernama" onBlur="checkAvailability()">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input class="form-control" name="confirm_password_name" type="password"
									placeholder="Ulangi password" id="confirm_password_id">
							</div>
	...
	<section id="footer" class="main-footer">
		<div class="container">
			<p><?php echo "Copyright © 2020 - " . (int)date('Y')?><a href="https://github.com/AhmadSubadri"> Dev. by AS</a> theme by themewagon.com</p>
