    ...
    <table id="datatable-fixed-header" class="table table-striped table-bordered">
      ...
      <tbody><?php 
        ...
        <tr>
          ...
          <td><a href="../privew/soal-<?php echo"$r[id]";?>-<?php echo"$r[id_matkul]";?>.html" target="_new"><button
                type="button" class="btn btn-success">Preview</button></a></td>
          <td>
            <div class="btn-group">
