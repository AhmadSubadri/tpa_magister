             ...
             <div class="x_content">
               ...
               <form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left">
                 ...
                 <div id="firstn" class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nama Depan<span
                       class="required">*</span>
                   </label>
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" name="firstn" required="required" class="form-control col-md-7 col-xs-12"
                       value="<?php echo"$rr[firstn]";?>">
                   </div>
                 </div>
                 <div id="lastn" class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nama Belakang <span
                       class="required">*</span>
                   </label>
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" name="lastn" required="required" class="form-control col-md-7 col-xs-12"
                       value="<?php echo"$rr[lastn]";?>">
                   </div>
                 </div>
                 <div id="username" class="form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" name="username" class="form-control col-md-7 col-xs-12" disabled
                 ...
                 <div id="nomerhp" class="form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <input class="form-control col-md-7 col-xs-12" type="text" name="nomerhp"
                       value="<?php echo"$rr[nomerhp]";?>">
                   </div>
                 </div>
