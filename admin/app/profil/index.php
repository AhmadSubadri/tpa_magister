               ...
               <form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left">
                 ...
                 <div class="form-group" id="nama_course">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" class="form-control col-md-7 col-xs-12" name="nama_course"
                       value="<?php echo"$rr[nama_course]";?>">
                   </div>
                 </div>
                 <div id="founder" class="form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" name="founder" required="required" class="form-control col-md-7 col-xs-12"
                       value="<?php echo"$rr[founder]";?>">
                   </div>
                 </div>
                 ...
                 <div id="no_tlp" class="form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <input type="text" name="no_tlp" class="form-control col-md-7 col-xs-12" name="no_tlp"
                       value="<?php echo"$rr[no_tlp]";?>">
                   </div>
                 </div>
