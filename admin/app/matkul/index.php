			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Tambah Program Kuliah</h4>
					</div>
	...
	(function ($) {
		...
		$(document).ready(function (e) {
			...
			$(document).on("click", ".hapus", function () {
				...
				alertify.confirm("Apakah anda yakin mau menghapus data mata kuliah ini?", function (
				e) {
					if (e) {
