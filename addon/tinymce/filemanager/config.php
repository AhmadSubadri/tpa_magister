...
$base_url="https://birolayananpsikologi.mercubuana-yogya.ac.id"; //url base of site if you want only relative url leave empty
$upload_dir = '/public_html/data/'; // path from base_url to upload base dir
